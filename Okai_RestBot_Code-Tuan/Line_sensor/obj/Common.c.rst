      ...
      000000                        497 	.ds 8
                                    ...
                                    571 ;	-----------------------------------------
      0003EB                        572 _InitialUART0_Timer1:
                           000007   573 	ar7 = 0x07
                           000006   574 	ar6 = 0x06
                           000005   575 	ar5 = 0x05
                           000004   576 	ar4 = 0x04
                           ...
                           000001   579 	ar1 = 0x01
                           000000   580 	ar0 = 0x00
      0003EB AC 82            [24]  581 	mov	r4,dpl
      0003ED AD 83            [24]  582 	mov	r5,dph
      0003EF AE F0            [24]  583 	mov	r6,b
      0003F1 FF               [12]  584 	mov	r7,a
                                    585 ;	lib/Common.c:25: P06_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      0003F2 53 B1 BF         [24]  586 	anl	_P0M1,#0xbf
      0003F5 53 B2 BF         [24]  587 	anl	_P0M2,#0xbf
                                    588 ;	lib/Common.c:26: P07_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      0003F8 53 B1 7F         [24]  589 	anl	_P0M1,#0x7f
      0003FB 53 B2 7F         [24]  590 	anl	_P0M2,#0x7f
                                    591 ;	lib/Common.c:28: SCON = 0x50;     	//UART0 Mode1,REN=1,TI=1
      0003FE 75 98 50         [24]  592 	mov	_SCON,#0x50
                                    593 ;	lib/Common.c:29: TMOD |= 0x20;    	//Timer1 Mode1
      000401 43 89 20         [24]  594 	orl	_TMOD,#0x20
                                    595 ;	lib/Common.c:31: set_SMOD;        	//UART0 Double Rate Enable
      000404 43 87 80         [24]  596 	orl	_PCON,#0x80
                                    597 ;	lib/Common.c:32: set_T1M;
      000407 43 8E 10         [24]  598 	orl	_CKCON,#0x10
                                    599 ;	lib/Common.c:33: clr_BRCK;        	//Serial port 0 baud rate clock source = Timer1
      00040A 53 C4 DF         [24]  600 	anl	_T3CON,#0xdf
                                    601 ;	lib/Common.c:36: TH1 = 256 - (1000000/u32Baudrate+1);               /*16 MHz */
      00040D 8C 17            [24]  602 	mov	__divulong_PARM_2,r4
      00040F 8D 18            [24]  603 	mov	(__divulong_PARM_2 + 1),r5
      000411 8E 19            [24]  604 	mov	(__divulong_PARM_2 + 2),r6
      000413 8F 1A            [24]  605 	mov	(__divulong_PARM_2 + 3),r7
      000415 90 42 40         [24]  606 	mov	dptr,#0x4240
      000418 75 F0 0F         [24]  607 	mov	b,#0x0f
      00041B E4               [12]  608 	clr	a
      00041C 12 06 4C         [24]  609 	lcall	__divulong
      00041F AC 82            [24]  610 	mov	r4,dpl
      000421 0C               [12]  611 	inc	r4
      000422 C3               [12]  612 	clr	c
      000423 E4               [12]  613 	clr	a
      000424 9C               [12]  614 	subb	a,r4
      000425 F5 8D            [12]  615 	mov	_TH1,a
                                    616 ;	lib/Common.c:41: set_TR1;
                                    617 ;	assignBit
      000427 D2 8E            [12]  618 	setb	_TR1
                                    619 ;	lib/Common.c:42: set_TI;						//For printf function must setting TI = 1
                                    620 ;	assignBit
      000429 D2 99            [12]  621 	setb	_TI
                                    622 ;	lib/Common.c:43: }
      00042B 22               [24]  623 	ret
                                    624 ;------------------------------------------------------------
                                    ...
                                    632 ;	-----------------------------------------
      00042C                        633 _InitialUART0_Timer3:
      00042C AC 82            [24]  634 	mov	r4,dpl
      00042E AD 83            [24]  635 	mov	r5,dph
      000430 AE F0            [24]  636 	mov	r6,b
      000432 FF               [12]  637 	mov	r7,a
                                    638 ;	lib/Common.c:47: P06_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      000433 53 B1 BF         [24]  639 	anl	_P0M1,#0xbf
      000436 53 B2 BF         [24]  640 	anl	_P0M2,#0xbf
                                    641 ;	lib/Common.c:48: P07_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit	
      000439 53 B1 7F         [24]  642 	anl	_P0M1,#0x7f
      00043C 53 B2 7F         [24]  643 	anl	_P0M2,#0x7f
                                    644 ;	lib/Common.c:50: SCON = 0x50;     //UART0 Mode1,REN=1,TI=1
      00043F 75 98 50         [24]  645 	mov	_SCON,#0x50
                                    646 ;	lib/Common.c:51: set_SMOD;        //UART0 Double Rate Enable
      000442 43 87 80         [24]  647 	orl	_PCON,#0x80
                                    648 ;	lib/Common.c:52: T3CON &= 0xF8;   //T3PS2=0,T3PS1=0,T3PS0=0(Prescale=1)
      000445 53 C4 F8         [24]  649 	anl	_T3CON,#0xf8
                                    650 ;	lib/Common.c:53: set_BRCK;        //UART0 baud rate clock source = Timer3
      000448 43 C4 20         [24]  651 	orl	_T3CON,#0x20
                                    652 ;	lib/Common.c:56: RH3    = HIBYTE(65536 - (1000000/u32Baudrate)-1);  		/*16 MHz */
      00044B 8C 17            [24]  653 	mov	__divulong_PARM_2,r4
      00044D 8D 18            [24]  654 	mov	(__divulong_PARM_2 + 1),r5
      00044F 8E 19            [24]  655 	mov	(__divulong_PARM_2 + 2),r6
      000451 8F 1A            [24]  656 	mov	(__divulong_PARM_2 + 3),r7
      000453 90 42 40         [24]  657 	mov	dptr,#0x4240
      000456 75 F0 0F         [24]  658 	mov	b,#0x0f
      000459 E4               [12]  659 	clr	a
      00045A 12 06 4C         [24]  660 	lcall	__divulong
      00045D AC 82            [24]  661 	mov	r4,dpl
      00045F AD 83            [24]  662 	mov	r5,dph
      000461 AE F0            [24]  663 	mov	r6,b
      000463 FF               [12]  664 	mov	r7,a
      000464 74 FF            [12]  665 	mov	a,#0xff
      000466 C3               [12]  666 	clr	c
      000467 9C               [12]  667 	subb	a,r4
      000468 74 FF            [12]  668 	mov	a,#0xff
      00046A 9D               [12]  669 	subb	a,r5
      00046B F9               [12]  670 	mov	r1,a
      00046C E4               [12]  671 	clr	a
      00046D 9E               [12]  672 	subb	a,r6
      00046E E4               [12]  673 	clr	a
      00046F 9F               [12]  674 	subb	a,r7
      000470 89 C6            [24]  675 	mov	_RH3,r1
                                    676 ;	lib/Common.c:57: RL3    = LOBYTE(65536 - (1000000/u32Baudrate)-1);			/*16 MHz */
      000472 74 FF            [12]  677 	mov	a,#0xff
      000474 C3               [12]  678 	clr	c
      000475 9C               [12]  679 	subb	a,r4
      000476 FC               [12]  680 	mov	r4,a
      000477 8C C5            [24]  681 	mov	_RL3,r4
                                    682 ;	lib/Common.c:63: set_TR3;         //Trigger Timer3
      000479 43 C4 08         [24]  683 	orl	_T3CON,#0x08
                                    684 ;	lib/Common.c:64: set_TI;					 //For printf function must setting TI = 1
                                    685 ;	assignBit
      00047C D2 99            [12]  686 	setb	_TI
                                    687 ;	lib/Common.c:65: }
      00047E 22               [24]  688 	ret
                                    689 ;------------------------------------------------------------
                                    ...
                                    697 ;	-----------------------------------------
      00047F                        698 _Receive_Data_From_UART0:
                                    699 ;	lib/Common.c:70: while (!RI);
      00047F                        700 00101$:
      00047F 30 98 FD         [24]  701 	jnb	_RI,00101$
                                    702 ;	lib/Common.c:71: c = SBUF;
      000482 85 99 82         [24]  703 	mov	dpl,_SBUF
                                    704 ;	lib/Common.c:72: RI = 0;
                                    705 ;	assignBit
      000485 C2 98            [12]  706 	clr	_RI
                                    707 ;	lib/Common.c:73: return (c);
                                    708 ;	lib/Common.c:74: }
      000487 22               [24]  709 	ret
                                    710 ;------------------------------------------------------------
                                    ...
                                    718 ;	-----------------------------------------
      000488                        719 _Send_Data_To_UART0:
      000488 AF 82            [24]  720 	mov	r7,dpl
                                    721 ;	lib/Common.c:78: TI = 0;
                                    722 ;	assignBit
      00048A C2 99            [12]  723 	clr	_TI
                                    724 ;	lib/Common.c:79: SBUF = c;
      00048C 8F 99            [24]  725 	mov	_SBUF,r7
                                    726 ;	lib/Common.c:80: while(TI==0);
      00048E                        727 00101$:
      00048E 30 99 FD         [24]  728 	jnb	_TI,00101$
                                    729 ;	lib/Common.c:81: }
      000491 22               [24]  730 	ret
                                    731 ;------------------------------------------------------------
                                    ...
                                    739 ;	-----------------------------------------
      000492                        740 _InitialUART1_Timer3:
      000492 AC 82            [24]  741 	mov	r4,dpl
      000494 AD 83            [24]  742 	mov	r5,dph
      000496 AE F0            [24]  743 	mov	r6,b
      000498 FF               [12]  744 	mov	r7,a
                                    745 ;	lib/Common.c:89: P02_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      000499 53 B1 FB         [24]  746 	anl	_P0M1,#0xfb
      00049C 53 B2 FB         [24]  747 	anl	_P0M2,#0xfb
                                    748 ;	lib/Common.c:90: P16_Quasi_Mode;		//Setting UART pin as Quasi mode for transmit
      00049F 53 B3 BF         [24]  749 	anl	_P1M1,#0xbf
      0004A2 53 B4 BF         [24]  750 	anl	_P1M2,#0xbf
                                    751 ;	lib/Common.c:92: SCON_1 = 0x50;   	//UART1 Mode1,REN_1=1,TI_1=1
      0004A5 75 F8 50         [24]  752 	mov	_SCON_1,#0x50
                                    753 ;	lib/Common.c:93: T3CON = 0x08;   	//T3PS2=0,T3PS1=0,T3PS0=0(Prescale=1), UART1 in MODE 1
      0004A8 75 C4 08         [24]  754 	mov	_T3CON,#0x08
                                    755 ;	lib/Common.c:94: clr_BRCK;
      0004AB 53 C4 DF         [24]  756 	anl	_T3CON,#0xdf
                                    757 ;	lib/Common.c:97: RH3    = HIBYTE(65536 - (1000000/u32Baudrate)-1);  		/*16 MHz */
      0004AE 8C 17            [24]  758 	mov	__divulong_PARM_2,r4
      0004B0 8D 18            [24]  759 	mov	(__divulong_PARM_2 + 1),r5
      0004B2 8E 19            [24]  760 	mov	(__divulong_PARM_2 + 2),r6
      0004B4 8F 1A            [24]  761 	mov	(__divulong_PARM_2 + 3),r7
      0004B6 90 42 40         [24]  762 	mov	dptr,#0x4240
      0004B9 75 F0 0F         [24]  763 	mov	b,#0x0f
      0004BC E4               [12]  764 	clr	a
      0004BD 12 06 4C         [24]  765 	lcall	__divulong
      0004C0 AC 82            [24]  766 	mov	r4,dpl
      0004C2 AD 83            [24]  767 	mov	r5,dph
      0004C4 AE F0            [24]  768 	mov	r6,b
      0004C6 FF               [12]  769 	mov	r7,a
      0004C7 74 FF            [12]  770 	mov	a,#0xff
      0004C9 C3               [12]  771 	clr	c
      0004CA 9C               [12]  772 	subb	a,r4
      0004CB 74 FF            [12]  773 	mov	a,#0xff
      0004CD 9D               [12]  774 	subb	a,r5
      0004CE F9               [12]  775 	mov	r1,a
      0004CF E4               [12]  776 	clr	a
      0004D0 9E               [12]  777 	subb	a,r6
      0004D1 E4               [12]  778 	clr	a
      0004D2 9F               [12]  779 	subb	a,r7
      0004D3 89 C6            [24]  780 	mov	_RH3,r1
                                    781 ;	lib/Common.c:98: RL3    = LOBYTE(65536 - (1000000/u32Baudrate)-1);			/*16 MHz */
      0004D5 74 FF            [12]  782 	mov	a,#0xff
      0004D7 C3               [12]  783 	clr	c
      0004D8 9C               [12]  784 	subb	a,r4
      0004D9 FC               [12]  785 	mov	r4,a
      0004DA 8C C5            [24]  786 	mov	_RL3,r4
                                    787 ;	lib/Common.c:104: set_TR3;         //Trigger Timer3
      0004DC 43 C4 08         [24]  788 	orl	_T3CON,#0x08
                                    789 ;	lib/Common.c:105: }
      0004DF 22               [24]  790 	ret
                                    791 ;------------------------------------------------------------
                                    ...
                                    799 ;	-----------------------------------------
      0004E0                        800 _Receive_Data_From_UART1:
                                    801 ;	lib/Common.c:111: while (!RI_1);
      0004E0                        802 00101$:
      0004E0 30 F8 FD         [24]  803 	jnb	_RI_1,00101$
                                    804 ;	lib/Common.c:112: c = SBUF_1;
      0004E3 85 9A 82         [24]  805 	mov	dpl,_SBUF_1
                                    806 ;	lib/Common.c:113: RI_1 = 0;
                                    807 ;	assignBit
      0004E6 C2 F8            [12]  808 	clr	_RI_1
                                    809 ;	lib/Common.c:114: return (c);
                                    810 ;	lib/Common.c:115: }
      0004E8 22               [24]  811 	ret
                                    812 ;------------------------------------------------------------
                                    ...
                                    820 ;	-----------------------------------------
      0004E9                        821 _Send_Data_To_UART1:
      0004E9 AF 82            [24]  822 	mov	r7,dpl
                                    823 ;	lib/Common.c:119: TI_1 = 0;
                                    824 ;	assignBit
      0004EB C2 F9            [12]  825 	clr	_TI_1
                                    826 ;	lib/Common.c:120: SBUF_1 = c;
      0004ED 8F 9A            [24]  827 	mov	_SBUF_1,r7
                                    828 ;	lib/Common.c:121: while(TI_1==0);
      0004EF                        829 00101$:
      0004EF 30 F9 FD         [24]  830 	jnb	_TI_1,00101$
                                    831 ;	lib/Common.c:122: }
      0004F2 22               [24]  832 	ret
                                    833 ;------------------------------------------------------------
                                    ...
                                    839 ;	-----------------------------------------
      0004F3                        840 __sdcc_external_startup:
                                    841 ;	lib/Common.c:144: __endasm;
      0004F3 75 C7 AA         [24]  842 	mov	0xC7, #0xAA
      0004F6 75 C7 55         [24]  843 	mov	0xC7, #0x55
      0004F9 75 FD 5A         [24]  844 	mov	0xFD, #0x5A
      0004FC 75 C7 AA         [24]  845 	mov	0xC7, #0xAA
      0004FF 75 C7 55         [24]  846 	mov	0xC7, #0x55
      000502 75 FD A5         [24]  847 	mov	0xFD, #0xA5
                                    848 ;	lib/Common.c:145: return 0;
      000505 75 82 00         [24]  849 	mov	dpl,#0x00
                                    850 ;	lib/Common.c:146: }
      000508 22               [24]  851 	ret
                                    852 	.area CSEG    (CODE)
                                    853 	.area CONST   (CODE)
