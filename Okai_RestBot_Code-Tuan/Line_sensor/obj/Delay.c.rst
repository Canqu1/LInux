      ...
      000509                        575 _Timer0_Delay100us:
                           ...
                           000001   582 	ar1 = 0x01
                           000000   583 	ar0 = 0x00
      000509 AC 82            [24]  584 	mov	r4,dpl
      00050B AD 83            [24]  585 	mov	r5,dph
      00050D AE F0            [24]  586 	mov	r6,b
      00050F FF               [12]  587 	mov	r7,a
                                    588 ;	lib/Delay.c:24: clr_T0M;                                		//T0M=0, Timer0 Clock = Fsys/12
      000510 53 8E F7         [24]  589 	anl	_CKCON,#0xf7
                                    590 ;	lib/Delay.c:25: TMOD |= 0x01;                         		  //Timer0 is 16-bit mode
      000513 43 89 01         [24]  591 	orl	_TMOD,#0x01
                                    592 ;	lib/Delay.c:26: set_TR0;                            		    //Start Timer0
                                    593 ;	assignBit
      000516 D2 8C            [12]  594 	setb	_TR0
                                    595 ;	lib/Delay.c:27: while (u32CNT != 0)
      000518                        596 00104$:
      000518 EC               [12]  597 	mov	a,r4
      000519 4D               [12]  598 	orl	a,r5
      00051A 4E               [12]  599 	orl	a,r6
      00051B 4F               [12]  600 	orl	a,r7
      00051C 60 1A            [24]  601 	jz	00106$
                                    602 ;	lib/Delay.c:29: TL0 = LOBYTE(TIMER_DIV12_VALUE_100us);	//Find  define in "Function_define.h" "TIMER VALUE"
      00051E 75 8A 7E         [24]  603 	mov	_TL0,#0x7e
                                    604 ;	lib/Delay.c:30: TH0 = HIBYTE(TIMER_DIV12_VALUE_100us);
      000521 75 8C FF         [24]  605 	mov	_TH0,#0xff
                                    606 ;	lib/Delay.c:31: while (TF0 != 1);       		            //Check Timer0 Time-Out Flag
      000524                        607 00101$:
                                    608 ;	lib/Delay.c:32: clr_TF0;
                                    609 ;	assignBit
      000524 10 8D 02         [24]  610 	jbc	_TF0,00127$
      000527 80 FB            [24]  611 	sjmp	00101$
      000529                        612 00127$:
                                    613 ;	lib/Delay.c:33: u32CNT --;
      000529 1C               [12]  614 	dec	r4
      00052A BC FF 09         [24]  615 	cjne	r4,#0xff,00128$
      00052D 1D               [12]  616 	dec	r5
      00052E BD FF 05         [24]  617 	cjne	r5,#0xff,00128$
      000531 1E               [12]  618 	dec	r6
      000532 BE FF 01         [24]  619 	cjne	r6,#0xff,00128$
      000535 1F               [12]  620 	dec	r7
      000536                        621 00128$:
      000536 80 E0            [24]  622 	sjmp	00104$
      000538                        623 00106$:
                                    624 ;	lib/Delay.c:35: clr_TR0;                       			        //Stop Timer0
                                    625 ;	assignBit
      000538 C2 8C            [12]  626 	clr	_TR0
                                    627 ;	lib/Delay.c:36: }
      00053A 22               [24]  628 	ret
                                    629 ;------------------------------------------------------------
                                    ...
                                    637 ;	-----------------------------------------
      00053B                        638 _Timer0_Delay1ms:
      00053B AC 82            [24]  639 	mov	r4,dpl
      00053D AD 83            [24]  640 	mov	r5,dph
      00053F AE F0            [24]  641 	mov	r6,b
      000541 FF               [12]  642 	mov	r7,a
                                    643 ;	lib/Delay.c:40: clr_T0M;                                		//T0M=0, Timer0 Clock = Fsys/12
      000542 53 8E F7         [24]  644 	anl	_CKCON,#0xf7
                                    645 ;	lib/Delay.c:41: TMOD |= 0x01;                           		//Timer0 is 16-bit mode
      000545 43 89 01         [24]  646 	orl	_TMOD,#0x01
                                    647 ;	lib/Delay.c:42: set_TR0;                              		  //Start Timer0
                                    648 ;	assignBit
      000548 D2 8C            [12]  649 	setb	_TR0
                                    650 ;	lib/Delay.c:43: while (u32CNT != 0)
      00054A                        651 00104$:
      00054A EC               [12]  652 	mov	a,r4
      00054B 4D               [12]  653 	orl	a,r5
      00054C 4E               [12]  654 	orl	a,r6
      00054D 4F               [12]  655 	orl	a,r7
      00054E 60 1A            [24]  656 	jz	00106$
                                    657 ;	lib/Delay.c:45: TL0 = LOBYTE(TIMER_DIV12_VALUE_1ms); 		//Find  define in "Function_define.h" "TIMER VALUE"
      000550 75 8A CA         [24]  658 	mov	_TL0,#0xca
                                    659 ;	lib/Delay.c:46: TH0 = HIBYTE(TIMER_DIV12_VALUE_1ms);
      000553 75 8C FA         [24]  660 	mov	_TH0,#0xfa
                                    661 ;	lib/Delay.c:47: while (TF0 != 1);                   		//Check Timer0 Time-Out Flag
      000556                        662 00101$:
                                    663 ;	lib/Delay.c:48: clr_TF0;
                                    664 ;	assignBit
      000556 10 8D 02         [24]  665 	jbc	_TF0,00127$
      000559 80 FB            [24]  666 	sjmp	00101$
      00055B                        667 00127$:
                                    668 ;	lib/Delay.c:49: u32CNT --;
      00055B 1C               [12]  669 	dec	r4
      00055C BC FF 09         [24]  670 	cjne	r4,#0xff,00128$
      00055F 1D               [12]  671 	dec	r5
      000560 BD FF 05         [24]  672 	cjne	r5,#0xff,00128$
      000563 1E               [12]  673 	dec	r6
      000564 BE FF 01         [24]  674 	cjne	r6,#0xff,00128$
      000567 1F               [12]  675 	dec	r7
      000568                        676 00128$:
      000568 80 E0            [24]  677 	sjmp	00104$
      00056A                        678 00106$:
                                    679 ;	lib/Delay.c:51: clr_TR0;                              		  //Stop Timer0
                                    680 ;	assignBit
      00056A C2 8C            [12]  681 	clr	_TR0
                                    682 ;	lib/Delay.c:52: }
      00056C 22               [24]  683 	ret
                                    684 ;------------------------------------------------------------
                                    ...
                                    692 ;	-----------------------------------------
      00056D                        693 _Timer1_Delay10ms:
      00056D AC 82            [24]  694 	mov	r4,dpl
      00056F AD 83            [24]  695 	mov	r5,dph
      000571 AE F0            [24]  696 	mov	r6,b
      000573 FF               [12]  697 	mov	r7,a
                                    698 ;	lib/Delay.c:57: clr_T1M;																		//T1M=0, Timer1 Clock = Fsys/12
      000574 53 8E EF         [24]  699 	anl	_CKCON,#0xef
                                    700 ;	lib/Delay.c:58: TMOD |= 0x10;																//Timer1 is 16-bit mode
      000577 43 89 10         [24]  701 	orl	_TMOD,#0x10
                                    702 ;	lib/Delay.c:59: set_TR1;																		//Start Timer1
                                    703 ;	assignBit
      00057A D2 8E            [12]  704 	setb	_TR1
                                    705 ;	lib/Delay.c:60: while (u32CNT != 0)
      00057C                        706 00104$:
      00057C EC               [12]  707 	mov	a,r4
      00057D 4D               [12]  708 	orl	a,r5
      00057E 4E               [12]  709 	orl	a,r6
      00057F 4F               [12]  710 	orl	a,r7
      000580 60 1A            [24]  711 	jz	00106$
                                    712 ;	lib/Delay.c:62: TL1 = LOBYTE(TIMER_DIV12_VALUE_10ms);		//Find  define in "Function_define.h" "TIMER VALUE"
      000582 75 8B EA         [24]  713 	mov	_TL1,#0xea
                                    714 ;	lib/Delay.c:63: TH1 = HIBYTE(TIMER_DIV12_VALUE_10ms);
      000585 75 8D CB         [24]  715 	mov	_TH1,#0xcb
                                    716 ;	lib/Delay.c:64: while (TF1 != 1);												//Check Timer1 Time-Out Flag
      000588                        717 00101$:
                                    718 ;	lib/Delay.c:65: clr_TF1;
                                    719 ;	assignBit
      000588 10 8F 02         [24]  720 	jbc	_TF1,00127$
      00058B 80 FB            [24]  721 	sjmp	00101$
      00058D                        722 00127$:
                                    723 ;	lib/Delay.c:66: u32CNT --;
      00058D 1C               [12]  724 	dec	r4
      00058E BC FF 09         [24]  725 	cjne	r4,#0xff,00128$
      000591 1D               [12]  726 	dec	r5
      000592 BD FF 05         [24]  727 	cjne	r5,#0xff,00128$
      000595 1E               [12]  728 	dec	r6
      000596 BE FF 01         [24]  729 	cjne	r6,#0xff,00128$
      000599 1F               [12]  730 	dec	r7
      00059A                        731 00128$:
      00059A 80 E0            [24]  732 	sjmp	00104$
      00059C                        733 00106$:
                                    734 ;	lib/Delay.c:68: clr_TR1;                               			//Stop Timer1
                                    735 ;	assignBit
      00059C C2 8E            [12]  736 	clr	_TR1
                                    737 ;	lib/Delay.c:69: }
      00059E 22               [24]  738 	ret
                                    739 ;------------------------------------------------------------
                                    ...
                                    747 ;	-----------------------------------------
      00059F                        748 _Timer2_Delay500us:
      00059F AC 82            [24]  749 	mov	r4,dpl
      0005A1 AD 83            [24]  750 	mov	r5,dph
      0005A3 AE F0            [24]  751 	mov	r6,b
      0005A5 FF               [12]  752 	mov	r7,a
                                    753 ;	lib/Delay.c:73: clr_T2DIV2;																	//Timer2 Clock = Fsys/4 
      0005A6 53 C9 BF         [24]  754 	anl	_T2MOD,#0xbf
                                    755 ;	lib/Delay.c:74: clr_T2DIV1;
      0005A9 53 C9 DF         [24]  756 	anl	_T2MOD,#0xdf
                                    757 ;	lib/Delay.c:75: set_T2DIV0;
      0005AC 43 C9 10         [24]  758 	orl	_T2MOD,#0x10
                                    759 ;	lib/Delay.c:76: set_TR2;                                		//Start Timer2
                                    760 ;	assignBit
      0005AF D2 CA            [12]  761 	setb	_TR2
                                    762 ;	lib/Delay.c:77: while (u32CNT != 0)
      0005B1                        763 00104$:
      0005B1 EC               [12]  764 	mov	a,r4
      0005B2 4D               [12]  765 	orl	a,r5
      0005B3 4E               [12]  766 	orl	a,r6
      0005B4 4F               [12]  767 	orl	a,r7
      0005B5 60 1A            [24]  768 	jz	00106$
                                    769 ;	lib/Delay.c:79: TL2 = LOBYTE(TIMER_DIV4_VALUE_500us);		//Find  define in "Function_define.h" "TIMER VALUE"
      0005B7 75 CC 30         [24]  770 	mov	_TL2,#0x30
                                    771 ;	lib/Delay.c:80: TH2 = HIBYTE(TIMER_DIV4_VALUE_500us);
      0005BA 75 CD F8         [24]  772 	mov	_TH2,#0xf8
                                    773 ;	lib/Delay.c:81: while (TF2 != 1);                   		//Check Timer2 Time-Out Flag
      0005BD                        774 00101$:
                                    775 ;	lib/Delay.c:82: clr_TF2;
                                    776 ;	assignBit
      0005BD 10 CF 02         [24]  777 	jbc	_TF2,00127$
      0005C0 80 FB            [24]  778 	sjmp	00101$
      0005C2                        779 00127$:
                                    780 ;	lib/Delay.c:83: u32CNT --;
      0005C2 1C               [12]  781 	dec	r4
      0005C3 BC FF 09         [24]  782 	cjne	r4,#0xff,00128$
      0005C6 1D               [12]  783 	dec	r5
      0005C7 BD FF 05         [24]  784 	cjne	r5,#0xff,00128$
      0005CA 1E               [12]  785 	dec	r6
      0005CB BE FF 01         [24]  786 	cjne	r6,#0xff,00128$
      0005CE 1F               [12]  787 	dec	r7
      0005CF                        788 00128$:
      0005CF 80 E0            [24]  789 	sjmp	00104$
      0005D1                        790 00106$:
                                    791 ;	lib/Delay.c:85: clr_TR2;                                		//Stop Timer2
                                    792 ;	assignBit
      0005D1 C2 CA            [12]  793 	clr	_TR2
                                    794 ;	lib/Delay.c:86: }
      0005D3 22               [24]  795 	ret
                                    796 ;------------------------------------------------------------
                                    ...
                                    804 ;	-----------------------------------------
      0005D4                        805 _Timer3_Delay100ms:
      0005D4 AC 82            [24]  806 	mov	r4,dpl
      0005D6 AD 83            [24]  807 	mov	r5,dph
      0005D8 AE F0            [24]  808 	mov	r6,b
      0005DA FF               [12]  809 	mov	r7,a
                                    810 ;	lib/Delay.c:90: T3CON = 0x07;                           		//Timer3 Clock = Fsys/128
      0005DB 75 C4 07         [24]  811 	mov	_T3CON,#0x07
                                    812 ;	lib/Delay.c:91: set_TR3;                                		//Trigger Timer3
      0005DE 43 C4 08         [24]  813 	orl	_T3CON,#0x08
                                    814 ;	lib/Delay.c:92: while (u32CNT != 0)
      0005E1                        815 00104$:
      0005E1 EC               [12]  816 	mov	a,r4
      0005E2 4D               [12]  817 	orl	a,r5
      0005E3 4E               [12]  818 	orl	a,r6
      0005E4 4F               [12]  819 	orl	a,r7
      0005E5 60 25            [24]  820 	jz	00106$
                                    821 ;	lib/Delay.c:94: RL3 = LOBYTE(TIMER_DIV128_VALUE_100ms); //Find  define in "Function_define.h" "TIMER VALUE"
      0005E7 75 C5 2C         [24]  822 	mov	_RL3,#0x2c
                                    823 ;	lib/Delay.c:95: RH3 = HIBYTE(TIMER_DIV128_VALUE_100ms);
      0005EA 75 C6 CF         [24]  824 	mov	_RH3,#0xcf
                                    825 ;	lib/Delay.c:96: while ((T3CON&SET_BIT4) != SET_BIT4);		//Check Timer3 Time-Out Flag
      0005ED                        826 00101$:
      0005ED AA C4            [24]  827 	mov	r2,_T3CON
      0005EF 53 02 10         [24]  828 	anl	ar2,#0x10
      0005F2 7B 00            [12]  829 	mov	r3,#0x00
      0005F4 BA 10 F6         [24]  830 	cjne	r2,#0x10,00101$
      0005F7 BB 00 F3         [24]  831 	cjne	r3,#0x00,00101$
                                    832 ;	lib/Delay.c:97: clr_TF3;
      0005FA 53 C4 EF         [24]  833 	anl	_T3CON,#0xef
                                    834 ;	lib/Delay.c:98: u32CNT --;
      0005FD 1C               [12]  835 	dec	r4
      0005FE BC FF 09         [24]  836 	cjne	r4,#0xff,00129$
      000601 1D               [12]  837 	dec	r5
      000602 BD FF 05         [24]  838 	cjne	r5,#0xff,00129$
      000605 1E               [12]  839 	dec	r6
      000606 BE FF 01         [24]  840 	cjne	r6,#0xff,00129$
      000609 1F               [12]  841 	dec	r7
      00060A                        842 00129$:
      00060A 80 D5            [24]  843 	sjmp	00104$
      00060C                        844 00106$:
                                    845 ;	lib/Delay.c:100: clr_TR3;                                		//Stop Timer3
      00060C 53 C4 F7         [24]  846 	anl	_T3CON,#0xf7
                                    847 ;	lib/Delay.c:101: }
      00060F 22               [24]  848 	ret
                                    849 ;------------------------------------------------------------
                                    ...
                                    857 ;	-----------------------------------------
      000610                        858 _Timer3_Delay10us:
      000610 AC 82            [24]  859 	mov	r4,dpl
      000612 AD 83            [24]  860 	mov	r5,dph
      000614 AE F0            [24]  861 	mov	r6,b
      000616 FF               [12]  862 	mov	r7,a
                                    863 ;	lib/Delay.c:105: T3CON = 0x07;                           		//Timer3 Clock = Fsys/128
      000617 75 C4 07         [24]  864 	mov	_T3CON,#0x07
                                    865 ;	lib/Delay.c:106: set_TR3;                                		//Trigger Timer3
      00061A 43 C4 08         [24]  866 	orl	_T3CON,#0x08
                                    867 ;	lib/Delay.c:107: while (u32CNT != 0)
      00061D                        868 00104$:
      00061D EC               [12]  869 	mov	a,r4
      00061E 4D               [12]  870 	orl	a,r5
      00061F 4E               [12]  871 	orl	a,r6
      000620 4F               [12]  872 	orl	a,r7
      000621 60 25            [24]  873 	jz	00106$
                                    874 ;	lib/Delay.c:109: RL3 = LOBYTE(TIMER_DIV4_VALUE_10us); //Find  define in "Function_define.h" "TIMER VALUE"
      000623 75 C5 D8         [24]  875 	mov	_RL3,#0xd8
                                    876 ;	lib/Delay.c:110: RH3 = HIBYTE(TIMER_DIV4_VALUE_10us);
      000626 75 C6 FF         [24]  877 	mov	_RH3,#0xff
                                    878 ;	lib/Delay.c:111: while ((T3CON&SET_BIT4) != SET_BIT4);		//Check Timer3 Time-Out Flag
      000629                        879 00101$:
      000629 AA C4            [24]  880 	mov	r2,_T3CON
      00062B 53 02 10         [24]  881 	anl	ar2,#0x10
      00062E 7B 00            [12]  882 	mov	r3,#0x00
      000630 BA 10 F6         [24]  883 	cjne	r2,#0x10,00101$
      000633 BB 00 F3         [24]  884 	cjne	r3,#0x00,00101$
                                    885 ;	lib/Delay.c:112: clr_TF3;
      000636 53 C4 EF         [24]  886 	anl	_T3CON,#0xef
                                    887 ;	lib/Delay.c:113: u32CNT --;
      000639 1C               [12]  888 	dec	r4
      00063A BC FF 09         [24]  889 	cjne	r4,#0xff,00129$
      00063D 1D               [12]  890 	dec	r5
      00063E BD FF 05         [24]  891 	cjne	r5,#0xff,00129$
      000641 1E               [12]  892 	dec	r6
      000642 BE FF 01         [24]  893 	cjne	r6,#0xff,00129$
      000645 1F               [12]  894 	dec	r7
      000646                        895 00129$:
      000646 80 D5            [24]  896 	sjmp	00104$
      000648                        897 00106$:
                                    898 ;	lib/Delay.c:115: clr_TR3;                                		//Stop Timer3
      000648 53 C4 F7         [24]  899 	anl	_T3CON,#0xf7
                                    900 ;	lib/Delay.c:116: }
      00064B 22               [24]  901 	ret
                                    902 	.area CSEG    (CODE)
                                    903 	.area CONST   (CODE)
